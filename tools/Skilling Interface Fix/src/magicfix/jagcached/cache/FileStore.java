package magicfix.jagcached.cache;
...
public class FileStore {
	 ...
	 */
	public magicfix.utilities.ByteBuffer get(int file) {
		try {
			...
			magicfix.utilities.ByteBuffer fileBuffer = new magicfix.utilities.ByteBuffer(size);
			int remaining = size;
			int chunk = 0;
	 ...
	 */
	public boolean put(int file, magicfix.utilities.ByteBuffer data, int size) {
		if (size < 0 || size > maxSize) {
